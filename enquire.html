                ...
                <fieldset class="purchase-product">
                    <legend>Purchase a product</legend>
                        ...
                        <div class="product-tabs">
                            ...
                            <label>
                                <input type="radio" name="product" value="vacuum1"> Ecovacs Deebot t20
                                <p class="product-price">$1,799</p>
                            </label>
                            <label>
                                <input type="radio" name="product" value="vacuum2"> Roborock s8
                            ...
                            <label>
                                <input type="radio" name="product" value="lawn-mower1"> LUBA AWD 5000
                                <p class="product-price">$4,399</p>
                            </label>
                            <label>
                                <input type="radio" name="product" value="lawn-mower2"> Segway Navimow H800A-VF 800m2
                            ...
                            <label>
                                <input type="radio" name="product" value="pool-cleaner1"> Madimack GT Freedom i80
                                <p class="product-price">$2,798</p>
                            </label>
                            <label>
                                <input type="radio" name="product" value="pool-cleaner2"> Zodiac FX18 Robotic Pool Cleaner
